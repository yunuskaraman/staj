        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        routingTable = _b.sent();
                        servers = accessMode === WRITE ? routingTable.writers : routingTable.readers;
                        return [2 /*return*/, Promise.all(servers.map(function (address) { return _this._verifyConnectivityAndGetServerVersion({ address: address }); }))
                                .then(function (_a) {
                                var _b = __read(_a, 1), serverInfo = _b[0];
                                return serverInfo;
                            })];
                }
            });
