...
export declare class TransactionExecutor {
    ...
    _executeTransactionInsidePromise<T>(transactionCreator: TransactionCreator, transactionWork: TransactionWork<T>, resolve: Resolve<T>, reject: Reject): Promise<void>;
