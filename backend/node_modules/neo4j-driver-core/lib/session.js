...
var Session = /** @class */ (function () {
     ...
     */
    function Session(_a) {
        var mode = _a.mode, connectionProvider = _a.connectionProvider, bookmarks = _a.bookmarks, database = _a.database, config = _a.config, reactive = _a.reactive, fetchSize = _a.fetchSize, impersonatedUser = _a.impersonatedUser;
        this._mode = mode;
        ...
        this._readConnectionHolder = new connection_holder_1.ConnectionHolder({
            mode: constants_2.ACCESS_MODE_READ,
            database: database,
            bookmarks: bookmarks,
        ...
        this._writeConnectionHolder = new connection_holder_1.ConnectionHolder({
            mode: constants_2.ACCESS_MODE_WRITE,
            database: database,
            bookmarks: bookmarks,
            connectionProvider: connectionProvider,
            impersonatedUser: impersonatedUser,
        ...
        this._lastBookmarks = bookmarks || bookmarks_1.Bookmarks.empty();
    ...
    Session.prototype.run = function (query, parameters, transactionConfig) {
        ...
        return this._run(validatedQuery, params, function (connection) {
            ...
            return connection.protocol().run(validatedQuery, params, {
                bookmarks: _this._lastBookmarks,
                ...
                lowRecordWatermark: _this._lowRecordWatermark,
                highRecordWatermark: _this._highRecordWatermark
            });
        });
    };
    ...
    Session.prototype.readTransaction = function (transactionWork, transactionConfig) {
        ...
        return this._runTransaction(constants_2.ACCESS_MODE_READ, config, transactionWork);
    };
    /**
    ...
    Session.prototype.writeTransaction = function (transactionWork, transactionConfig) {
        var config = new tx_config_1.TxConfig(transactionConfig);
        return this._runTransaction(constants_2.ACCESS_MODE_WRITE, config, transactionWork);
    };
     ...
     * @returns {void}
     */
    Session.prototype._updateBookmarks = function (newBookmarks) {
    ...
    Session.prototype._connectionHolderWithMode = function (mode) {
        if (mode === constants_2.ACCESS_MODE_READ) {
            return this._readConnectionHolder;
        }
        else if (mode === constants_2.ACCESS_MODE_WRITE) {
    ...
    Session.prototype._onCompleteCallback = function (meta) {
        this._updateBookmarks(new bookmarks_1.Bookmarks(meta.bookmark));
    };
    /**
     * @private
     * @returns {void}
    ...
    Session._validateSessionMode = function (rawMode) {
        var mode = rawMode || constants_2.ACCESS_MODE_WRITE;
        if (mode !== constants_2.ACCESS_MODE_READ && mode !== constants_2.ACCESS_MODE_WRITE) {
