...
var Transaction = /** @class */ (function () {
     ...
     * @returns {void}
     */
    Transaction.prototype._begin = function (bookmarks, txConfig, events) {
        var _this = this;
            ...
            if (connection) {
                return connection.protocol().beginTransaction({
                    ...
                    beforeError: function (error) {
                        ...
                        return _this._onError(error).catch(function () { });
                    },
    ...
    Transaction.prototype._onCompleteCallback = function (meta) {
        this._onBookmarks(new bookmarks_1.Bookmarks(meta.bookmark));
    };
    return Transaction;
}());
var _states = {
    ...
    ACTIVE: {
        ...
        run: function (query, parameters, _a) {
            var connectionHolder = _a.connectionHolder, onError = _a.onError, onComplete = _a.onComplete, onConnection = _a.onConnection, reactive = _a.reactive, fetchSize = _a.fetchSize, highRecordWatermark = _a.highRecordWatermark, lowRecordWatermark = _a.lowRecordWatermark;
