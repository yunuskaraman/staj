 ...
 * @return {void}
 */
var DEFAULT_ON_KEYS = function (_keys) { };
/**
...
var Result = /** @class */ (function () {
    ...
    Result.prototype[Symbol.asyncIterator] = function () {
        ...
        var controlFlow = function () {
            ...
            var queueSizeIsOverHighOrEqualWatermark = state.queuedObserver.size >= _this._watermarks.high;
            var queueSizeIsBellowOrEqualLowWatermark = state.queuedObserver.size <= _this._watermarks.low;
            ...
            next: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, state.queuedObserver.dequeue()];
                        case 2:
                            next = _a.sent();
                            if (next.done) {
            ...
            peek: function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, state.queuedObserver.head()];
    ...
    Result.prototype._decorateObserver = function (observer) {
        ...
        var onKeysOriginal = observer.onKeys || DEFAULT_ON_KEYS;
    ...
    Result.prototype._createQueuedResultObserver = function (onQueueSizeChanged) {
        ...
        var observer = {
            ...
            dequeue: function () { return __awaiter(_this, void 0, void 0, function () {
                var element;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (buffer.length > 0) {
                                element = buffer.shift();
                                onQueueSizeChanged();
                                if (isError(element)) {
                                    throw element;
                                }
